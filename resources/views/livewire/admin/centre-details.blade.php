<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <section class="bg-gradient-to-br text-white py-16 px-4 sm:px-6 lg:px-8 shadow-xl">
        <div class="max-w-5xl mx-auto">
            <div class="flex items-center mb-6">
                <a href="{{ route('admin.etablissements') }}" class="flex items-center text-blue-200 hover:text-white transition-colors">
