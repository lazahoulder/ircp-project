...
new class extends Component {
    ...
    public function render(): mixed
    {
        ...
        if (Auth::user()->entiteEmmeteur) {
            $query->where('entite_emmeteur_id', Auth::user()->entiteEmmeteur->id);
        }

        $formations = $query->latest()->paginate(10);

        return view('livewire.mysetting.user-formations', [
...
<section class="max-w-8xl mx-auto p-10 lg:pl-40 lg:pr-40 md:pl-15 md:pr-15 sm:pl-10 sm:pr-10 h-full min-h-screen">
    ...
    <x-site-settings.layout :heading="__('Mes formations')" class="w-full h-full">
        <div class="space-y-6">
